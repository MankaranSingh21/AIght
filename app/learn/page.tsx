...
import LearnProgressClient from "@/components/learn/LearnProgressClient";
import ConceptListClient from "@/components/learn/ConceptListClient";
    ...
    <main style={{ minHeight: "100vh", position: "relative", zIndex: 1 }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.14em",
            textTransform: "uppercase", color: "rgba(245,239,224,0.30)", marginBottom: 20,
          }}>
            All concepts — {allConcepts.length} articles
          </p>
          <LearnProgressClient />
          <ConceptListClient concepts={allConcepts} />
        </div>
      </section>
