...
readTime: "7 min read"
slug: "mcp"
related: ["agents", "multiagent", "prompt-engineering", "function-calling"]
prerequisites: ["function-calling", "agents"]
successors: ["multiagent"]
exemplar_tools: ["cursor", "claude", "windsurf"]
key_fields: ["software-engineering"]
misconceptions:
  - "MCP is a Claude-only thing."
  - "MCP lets the model do anything on your machine."
  - "MCP servers are hard to write."
