...
## Route each task to the right modality

Eight real tasks. For each one, pick which input modality a model would need to handle it correctly.

<ModalityRouter />

<KnowledgeCheck slug="multimodal" />
