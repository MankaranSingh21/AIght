...
readTime: "8 min read"
slug: "fine-tuning"
related: ["rag", "prompt-engineering", "training", "rlhf", "dpo"]
prerequisites: ["training", "rlhf"]
successors: ["dpo", "constitutional-ai"]
exemplar_tools: ["chatgpt", "claude"]
key_fields: ["medicine-healthcare", "law-legal", "marketing-advertising", "biology", "creative-writing-literature"]
misconceptions:
  - "Fine-tuning is the answer when prompts fail."
  - "Fine-tuning teaches the model new facts."
  - "Fine-tuned models are private by default."
